...
export function SobreFeedbackCard({ className }: { className?: string }) {
  ...
  return (
    <ContextFeedbackCard
      title="Sobre"
      description={'A engenharia e a filosofia por trás do Hub-HUB IME. Aqui contamos como saímos da prancheta e da observação de um "gap" visual para a criação deste código. Entenda nossa evolução de um repositório para um ecossistema interativo focado em UX Inclusiva, construído com arquitetura de ponta e inspirado no MIT Comm Lab. Conheça a nossa visão para o futuro da divulgação. Como um projeto (Beta), sua percepção é vital. O que achou da nossa arquitetura e proposta? Nos conte!'}
      betaTag={true}
